            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // --- 3. HARİTALAR KISMI ---
                  _buildSectionHeader(context.tr('Maps')),
                  const SizedBox(height: 8),
                  ...
                  SizedBox(
                    ...
                    child: Consumer<MapsProvider>(
                      builder: (context, mapsProvider, child) {
                        ...
                        if (mapsProvider.allMaps.isEmpty) {
                          return Text(context.tr('No maps has been added yet.'), style: const TextStyle(color: Colors.grey));
                        }
                  ...
                  notesProvider.isLoading
                      ...
                      ? Center(child: Text(context.tr('No notes has been added yet.'), style: const TextStyle(color: Colors.grey)))
                      : ListView.builder(
                    shrinkWrap: true,
