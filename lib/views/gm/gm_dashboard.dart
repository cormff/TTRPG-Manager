      ...
      body: SafeArea(
        ...
        child: RefreshIndicator(
          ...
          child: SingleChildScrollView(
            physics:
                const AlwaysScrollableScrollPhysics(), // YENİ: Liste kısa olsa bile kaydırılıp yenilenebilmesi için
            ...
            child: Column(
              ...
              children: [
                ...
                gamesProvider.isLoading
                    ...
                    : SizedBox(
                        ...
                        child: ListView.builder(
                          ...
                          itemCount:
                              (allGmGames.length > 4 ? 4 : allGmGames.length) +
                              1,
                    ...
                    : SizedBox(
                        ...
                        child: allNpcs.isEmpty
                            ...
                            : ListView.builder(
                                ...
                                scrollDirection: Axis.horizontal,
                                itemCount:
                                    (allNpcs.length > 6 ? 6 : allNpcs.length) +
                                    1,
                                itemBuilder: (context, index) {
                ...
                _buildSectionHeader(
                  context.tr('maps'),
                ), // YENİ: Başlık diğerleriyle tam aynı hizaya alındı
                const SizedBox(height: 8),
                  ...
                  child: Consumer<MapsProvider>(
                    builder: (context, mapsProvider, child) {
                      ...
                      return ListView.builder(
                        padding: EdgeInsets
                            .zero, // YENİ: Ekstra boşluk silindi, tam soldan başlar
                        scrollDirection: Axis.horizontal,
                            ...
                            return GestureDetector(
                              onTap: () {
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => const MyMapsView(),
                                  ),
                                );
                              },
                              child: Container(
                ...
                Center(
                  child: Padding(
                    ...
                    child: TextButton.icon(
                      ...
                      label: Text(context.tr('seeAllNotes')),
                    ),
                  ),
                ),
              ],
