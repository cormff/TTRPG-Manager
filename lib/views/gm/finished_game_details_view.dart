...
class FinishedGameDetailsView extends StatefulWidget {
  ...
  @override
  State<FinishedGameDetailsView> createState() =>
      _FinishedGameDetailsViewState();
}
...
class _FinishedGameDetailsViewState extends State<FinishedGameDetailsView> {
  ...
  Future<void> _loadArchiveData() async {
    ...
    final futures = await Future.wait([
      ...
      if (widget.game.id != null)
        gameService.getGameNotes(widget.game.id!)
      else
        Future.value([]),
    ]);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(context.tr('gameArchive')),
                  ...
                  if (widget.game.joinedPlayerIds.isEmpty)
                    ...
                    Wrap(
                      ...
                      children: widget.game.joinedPlayerIds.map((id) {
                        final playerName =
                            _playerNames[id] ?? context.tr('unknownHero');
                        return Chip(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return Card(
                          ...
                          child: ListTile(
                            ...
                            title: Text(
                              note['title'] ?? context.tr('namelessNote'),
                              style: const TextStyle(
                                fontWeight: FontWeight.bold,
                                color: Colors.white,
                              ),
